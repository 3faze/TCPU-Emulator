...
async def run_window():
    while True:
        ...
        for curr_reg in reg_positions:
            text = text_font.render(reg_positions[curr_reg].name + " : " + str(reg_positions[curr_reg].value), True, (255, 255, 255))
...
async def main():
    tasks = []
    tasks.append(asyncio.create_task(run_console()))
    tasks.append(asyncio.create_task(run_window()))
